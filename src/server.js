...
ICT pack: tv_ict → chart-region PNGs by default; collapses right script panel + bottom Pine widget before each shot (restores after) unless ict_report.hide_pine_editor is false; does NOT inject Pine source
